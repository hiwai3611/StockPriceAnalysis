...
#    <p class="ud_date">毎日7時20分更新</p>
#		<dl>
#		<dt>3月20日<span class="title_item">予想</span></dt>
#       <a href="/correlations/?from-top"><dd class="fall">21,214.62<p class="before_ratio fall">-266.28(-1.26%)</p></dd></a>
#		<!--<dd class="fall">19976.41<p class="before_ratio fall">+51.25(+0.26)</p></dd>-->
#		</dl>
#	<div class="ave_index_wrap">
#    <p>現在値<span id="nikkei_real_date">20日 15:00<!--12日11:00--></span></p>
#    <div id="nikkei_real_val" class="ave_index_num" data-latest="21380.97">21,380.97<!--19976.41--><span class="fall">-99.93(-0.47%)</span><!--<span class="rise">+51.25(+0.26)--></div>
#    </div>
#
#<ul class="real_date_sub_item">
#<li>前日終値<span>21,480.90</span></li>
#<li>始値<span>21,297.98</span></li>
#<li>レンジ<span>21,223.97 - 21,384.86</span></li>
#</ul>

#<p>現在値<spanid="nikkei_real_date">20日15:00<!--12日11:00--></span></p><divid="nikkei_real_val"class="ave_index_num"data-latest="21380.97">21380.97<!--19976.41-->,-99.93(-0.47%)</span><!--,+51.25(+0.26)--></div></div><ulclass="real_date_sub_item">

# 取得データのプリント # TEST
$res7 =~ s/,//g; #"
$res7 =~ s/\<dt\>(\d*)月(\d*)日\<span class=\"title_item\"\>予想\<\/span\>\<\/dt\>/$1月$2日予想/g; #"
$res7 =~ s/\<a href=\"\/correlations\/\?from-top\"\>\<dd class=\"\w*\"\>(\d*)\.(\d*)\<p class=\"before_ratio \w*\"\>(\W*)(\d*)\.(\d*)\((\W*)(\d*)\.(\d*)%\)\<\/p\>\<\/dd\>\<\/a\>/$1.$2（$3$4.$5）（$6$7.$8%）/g; #"
$res7 =~ s/\<li\>前日終値\<span\>(\d*)\.(\d*)\<\/span\>\<\/li\>/前日終値：$1.$2, /g; #"
$res7 =~ s/\<li\>始値\<span\>(\d*)\.(\d*)\<\/span\>\<\/li\>/前日始値：$1.$2, /g; #"
$res7 =~ s/\<li\>レンジ\<span\>(\d*).(\d*)(\s*)-(\s*)(\d*)\.(\d*)\<\/span\>\<\/li\>/レンジ：$1.$2 - $5.$6, /g; #"
$res7 =~ s/\<\/ul\>/\n/g; #"
...
$res7 =~ s/\<li\>\<ahref=\"\/blog\/frb-chairman-candidate\/\">.*//g; #" #2018/03/21追加
$res7 =~ s/\<p\>現在値\<spanid=\"nikkei_real_date\"\>.*\<ulclass=\"real_date_sub_item\"\>//g; #" #2018/03/21追加
$res7 =~ s/<.*>//g; #"
